...
public class Test {
    ...
    public static void main(String[] args) {
      ...
      bcm2835.bi_delay ( 5000 );
      System.out.print("Wait 5sec\n");
      bcm2835.ope_sync();
      System.out.print("return now!\n");
      bcm2835.bi_delayMicroseconds ( 10000000 );
      System.out.print("Wait 10sec\n");
      bcm2835.ope_sync();
      System.out.print("return now!\n");
      ...
      bcm2835.st_read();
      bcm2835.st_delay(10000, 10000);
      bcm2835.bcm_close();
      System.out.print("Sync\n");
      bcm2835.ope_sync();

      System.out.print("Test on DEBUG\n");
